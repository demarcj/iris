...
// Styles
import { label, disabled_class, VisuallyHiddenInput } from '@/_styles';
...
export const InputUI: React.FC<InputModel> = ({ 
  ...
  const menu_map = {
    ...
    furnished: FurnishedMap,
    location: LocationMap,
    option: OptionMap,
    ownership: OwnershipMap,
    sub_district: SubDistrictMap,
              ...
              { 
                list.map((menu, i) => (
                  <Option key={i} value={ menu }>
                    { (menu_map?.[key_name as keyof typeof menu_map] as any)?.[menu]?.[language] || menu }
                  </Option>
                ))
              }
            </Select>
